  ...
  return (
   ...
   <div className="col-span-12 border rounded-md md:col-span-6 lg:col-span-4 h-fit">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p>₹ <span className="text-lg font-semibold">{grossValue  ? grossValue : "-"}</span></p>
                </div>
                <div className="flex items-center justify-between">
                  <p className="text-lg text-black/70">Discount Amount</p>
                  <p>₹ <span className="text-lg font-semibold">{totalSavings  ? totalSavings.toFixed(0) : "-"}</span></p>
                </div>
                {/* <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between px-6 py-4">
                  ...
                  <p>₹ <span className="text-xl font-bold">{discountedTotal ? discountedTotal.toFixed(0) : "-"}</span></p>
                </div>
