...
import { postDefaultAddressApi, postsShippingAddressApi, putShippingAddressApi } from "../../../api-service/landingApi";
        ...
        {openAddress ? (
            ...
            { openAddress ? (
              ...
              <button type="button" className="border rounded-md px-3 py-2"
                        onClick={()=>setOpenAddress(!openAddress)}>Cancel</button>
                               <button type="submit" className="bg-primaryColor text-white hover:bg-yellow-400 hover:text-black px-3 py-2 rounded-md">Update</button>
              </div>
              </form>
            ) : ""}
